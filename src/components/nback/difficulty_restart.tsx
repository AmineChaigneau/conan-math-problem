...
export type NbackDifficultyRestartProps = {
  ...
  onDataCollection: (data: NbackDifficultyRestartData) => void;
};

export const NbackDifficultyRestart = ({
  trialId,
  trialResults,
  currentLevel,
  remainingTrials,
  ...
  const handleMouseUp = (e: React.MouseEvent) => {
    ...
    if (choiceButton) {
      ...
      const choiceData: NbackDifficultyRestartData = {
        timeStamp: new Date().toISOString(),
        trialId: trialId,
        trialResults: trialResults,
        currentLevel: currentLevel,
        selectedChoice: isSwitchToEasier ? "easier" : "restart",
      ...
      <div ref={containerRef} className="relative h-full w-full">
        ...
        >
          <div className="flex flex-col items-center gap-2">
            ...
            <h2 className="text-3xl">Sequence Failed</h2>
